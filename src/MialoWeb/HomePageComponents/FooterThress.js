    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-column">
          ...
          <ul>
            <li>
              <Link to="/solutions#shopper-analytics">Shopper Analytics</Link>
            </li>
            <li>
              <Link to="/solutions#smart-parking">Smart Parking</Link>
            </li>
            <li>
              <Link to="/solutions#smart-security">Smart Security</Link>
            </li>
            <li>
              <Link to="/solutions#access-control">Access Control</Link>
            </li>
            <li>
              <Link to="/solutions#document-processing">Document Processing</Link>
            </li>
            <li>
              <Link to="/solutions#generative-ai">Gen & Conversational AI</Link>
            </li>
          </ul>
        </div>
        <div className="footer-column">
