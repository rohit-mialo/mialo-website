        ...
        <Container>
          <Grid container alignItems="flex-start">
            <Grid item xs={12} lg={5}>
              <MKTypography className="content-header" variant="h1" my={1} color="black">
                Our Vision
              </MKTypography>
              <MKTypography className="content-body" variant="body1" color="text" sx={{textAlign:"justify"}}   mb={2}>
            ...
            <Grid item xs={12} lg={5} sx={{ ml: { xs: -2, lg: "auto" }, mt: { xs: 6, lg: 0 } }}>
              <Stack>
                ...
                <MKTypography variant="body1" color="text" mb={2} sx={{textAlign:"justify"}}>
